            ...
            <div className={outer}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={styles.score}>
                        <label>Score: {score} <FontAwesomeIcon icon={faStar} /> </label>
                        <input 
                            type="Range" 
                            min="0" 
                            max="10" 
                    ...
                    <div>
                        <a href="/personal" className={styles.personal}>
                        <FontAwesomeIcon icon={faPerson}/> Personal 
                        </a>
                    </div>
